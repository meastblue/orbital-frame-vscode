...
export function activate(context: vscode.ExtensionContext) {
	const provider = new OrbitalFrameViewProvider(context.extensionUri);

	context.subscriptions.push(
		vscode.window.registerWebviewViewProvider(
			OrbitalFrameViewProvider.viewType,
			provider
		)
	);
...
function updateDiagnostics(provider: OrbitalFrameViewProvider): void {
...
class OrbitalFrameViewProvider implements vscode.WebviewViewProvider {
	public static readonly viewType = "orbitalframe.hello";
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		return `<!DOCTYPE html>
			...
			<head>
				...
				<title>Orbital Frame</title>
			</head>
			<body>
				<hey-orbitalframe class="glow">
					<div class="container">
						<div class="body">
						<div class="face">
